...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "organization" ADD CONSTRAINT "organization_created_by_lp_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."lp_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "org_invite" ADD CONSTRAINT "org_invite_inviter_lp_user_id_fk" FOREIGN KEY ("inviter") REFERENCES "public"."lp_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "user_org" ADD CONSTRAINT "user_org_user_id_lp_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."lp_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
